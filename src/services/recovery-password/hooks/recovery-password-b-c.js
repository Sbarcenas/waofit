...
module.exports = function (options = {}) {
    ...
    return async (context) => {
        ...
        if (!records.email)
            throw new NotAcceptable('Debes enviar el email.')
        ...
        const data = await context.app.service('users').patch(user.id, { token_reset_password: generate('123456789', 4) })
        ...
        await context.app.service('send-notifications').create({ ...sendNotication })
