...
const {
  ExpressProductsNutritionalTable
} = require("./express-products-nutritional-table.class");
...
module.exports = function(app) {
  const options = {
    ...
    allowedEager: "[expressNutritionTableOptionName]",
  ...
  app.use(
    ...
    new ExpressProductsNutritionalTable(options, app)
  );
